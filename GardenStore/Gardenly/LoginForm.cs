    ...
    public partial class LoginForm : Form
    {
        ...
        private void buttonLogin_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.Now < blockUntil_)
            {
                ...
                MessageBox.Show("Вход заблокирован. Попробуйте снова через " + remaining.Minutes + " мин. " + remaining.Seconds + " сек.", "Вход заблокирован", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            User user = service.AuthorizeUser(textBoxLogin.Text.Trim(), textBoxPassword.Text);
            ...
            else
            {
                ...
                if (attempts_ == 0)
                {
                    ...
                    MessageBox.Show("Вы три раза ввели неверный логин или пароль.\n\n" + "Вход заблокирован на 5 минут.", "Вход заблокирован", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
